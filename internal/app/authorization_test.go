...
func TestFixedRolesCoverEveryProtectedRouteClass(t *testing.T) {
	...
	tests := []struct {
		...
		{"file download", http.MethodGet, "/resources/files/download/script.ps1", []userRole{roleAdministrator, roleMaintainer, roleOperator}},
		...
		{"file script task", http.MethodGet, "/resources/files/run/script.ps1", []userRole{roleAdministrator, roleMaintainer, roleOperator}},
		...
		{"file settings", http.MethodGet, "/settings/files", []userRole{roleAdministrator, roleMaintainer, roleOperator}},
