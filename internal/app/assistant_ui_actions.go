...
func (a *App) assistantUIActions() []assistantUIActionSpec {
	...
	return []assistantUIActionSpec{
		...
		action("websites.create", "Create website monitor", "websites", "/monitor/websites", "/monitor/websites", nil, []string{"name", "scope", "kind", "url", "verify_tls", "http_method", "http_content_type", "http_body", "http_success_mode", "response_keyword", "follow_redirects", "websocket_success", "ping_payload_format", "ping_payload", "send_type", "send_payload", "receive_type", "expected_message", "frequency_seconds", "timeout_seconds", "expected_statuses"}, a.createWebsiteMonitor),
		...
		action("websites.update", "Update website monitor", "websites", "/monitor/websites/{id}", "/monitor/websites", []string{"id"}, []string{"name", "scope", "kind", "url", "verify_tls", "http_method", "http_content_type", "http_body", "http_success_mode", "response_keyword", "follow_redirects", "websocket_success", "ping_payload_format", "ping_payload", "send_type", "send_payload", "receive_type", "expected_message", "frequency_seconds", "timeout_seconds", "expected_statuses"}, a.updateWebsiteMonitor),
