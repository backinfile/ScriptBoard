...
var webMessages = map[string]localizedMessage{
	...
	"applications.description":              {"查看本机应用和 Docker 容器的 CPU、内存与磁盘使用情况。", "Inspect CPU, memory, and disk usage for host applications and Docker containers."},
	"applications.snapshot_facts":           {"应用快照事实", "Application snapshot facts"},
	...
	"applications.pinned_count":             {"已 Pin 应用", "Pinned applications"},
	"applications.collected":                {"采集时间", "Collected"},
	"applications.focus":                    {"重点关注", "Focus"},
	"applications.pinned":                   {"已 Pin 应用", "Pinned applications"},
	"applications.pinned_description":       {"查看已关注应用的当前资源使用情况。", "Review current resource use for the applications you follow."},
	...
	"applications.pause_pinned_live":        {"暂停已 Pin 应用实时更新", "Pause live updates for pinned applications"},
	"applications.start_pinned_live":        {"开启已 Pin 应用实时更新", "Start live updates for pinned applications"},
	...
	"applications.no_pins":                  {"尚未 Pin 应用，可从下方正在运行列表添加。", "No applications are pinned. Add one from the running list below."},
	...
	"applications.running_description":      {"点击列标题可切换排序；默认按 CPU 降序显示前 100 个应用。", "Select a column heading to change sorting. The first 100 applications are shown by CPU descending."},
	...
	"applications.pin":                      {"Pin", "Pin"},
	"applications.unpin":                    {"取消 Pin", "Unpin"},
	...
	"applications.identity_restricted":      {"无法读取可执行路径，不能 Pin。", "The executable path is unavailable, so this application cannot be pinned."},
	...
	"settings.description":                  {"管理账户、本地版本保护与应用更新。", "Manage the account, local version protection, and application updates."},
	"settings.sections":                     {"设置分区", "Settings sections"},
	"settings.account":                      {"账户", "Account"},
	"updates.title":                         {"应用更新", "Application updates"},
	"updates.description":                   {"检查官方稳定版，并在确认后安全切换服务版本。", "Check official stable releases and safely switch the service after confirmation."},
