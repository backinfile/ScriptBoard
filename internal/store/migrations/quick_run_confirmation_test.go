...
func TestSchema61DefaultsExistingQuickRunsToNoConfirmation(t *testing.T) {
	...
	if err := Apply(db, 60, Options{CurrentVersion: 61, RandomToken: func(int) (string, error) { return "token", nil }, HashToken: func(value string) string { return value }, Now: time.Now}); err != nil {
		t.Fatal(err)
	}
