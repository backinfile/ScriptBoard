...
func TestFixedRolesCoverEveryProtectedRouteClass(t *testing.T) {
	...
	tests := []struct {
		...
		{"documents page", http.MethodGet, "/resources/documents", []identity.Role{identity.RoleAdministrator, identity.RoleMaintainer, identity.RoleOperator}},
		{"document move group task", http.MethodGet, "/resources/documents/move-group?path=C%3A%5Cdocs%5Crunbook.md", []identity.Role{identity.RoleAdministrator, identity.RoleMaintainer, identity.RoleOperator}},
		{"document mutation", http.MethodPost, "/resources/documents", []identity.Role{identity.RoleAdministrator, identity.RoleMaintainer, identity.RoleOperator}},
		{"document reorder", http.MethodPost, "/resources/documents/reorder", []identity.Role{identity.RoleAdministrator, identity.RoleMaintainer, identity.RoleOperator}},
		...
		{"workflow state", http.MethodGet, "/workflow/state", []identity.Role{identity.RoleAdministrator, identity.RoleMaintainer, identity.RoleOperator, identity.RoleViewer}},
		{"workflow import", http.MethodPost, "/workflow/import", []identity.Role{identity.RoleAdministrator, identity.RoleMaintainer}},
		{"workflow export", http.MethodPost, "/workflow/export", []identity.Role{identity.RoleAdministrator, identity.RoleMaintainer}},
		{"workflow save", http.MethodPost, "/workflow/save", []identity.Role{identity.RoleAdministrator, identity.RoleMaintainer}},
		{"workflow edit", http.MethodPost, "/workflow/draft", []identity.Role{identity.RoleAdministrator, identity.RoleMaintainer}},
		{"workflow run", http.MethodPost, "/workflow/start", []identity.Role{identity.RoleAdministrator, identity.RoleMaintainer, identity.RoleOperator}},
		{"workflow recovery", http.MethodPost, "/workflow/resolve", []identity.Role{identity.RoleAdministrator, identity.RoleMaintainer}},
