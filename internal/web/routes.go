...
func (a *App) routes() http.Handler {
	...
	mux.Handle("GET /config/custom-tabs", a.requirePermission(identity.PermissionManageOperations, http.HandlerFunc(a.customTabsPage)))
	mux.Handle("POST /config/custom-tabs", a.requireStepUp(identity.PermissionManageOperations, http.HandlerFunc(a.createCustomTab)))
	mux.Handle("POST /config/custom-tabs/{id}", a.requireStepUp(identity.PermissionManageOperations, http.HandlerFunc(a.updateCustomTab)))
	mux.Handle("POST /config/custom-tabs/{id}/toggle", a.requirePermission(identity.PermissionManageOperations, http.HandlerFunc(a.toggleCustomTab)))
	mux.Handle("POST /config/custom-tabs/{id}/move", a.requirePermission(identity.PermissionManageOperations, http.HandlerFunc(a.moveCustomTab)))
	mux.Handle("POST /config/custom-tabs/{id}/delete", a.requireStepUp(identity.PermissionManageOperations, http.HandlerFunc(a.deleteCustomTab)))
	mux.Handle("GET /defined/tabs/{id}", a.requirePermission(identity.PermissionObserve, http.HandlerFunc(a.customTabFramePage)))
	mux.Handle("POST /defined/tabs/{id}/key-challenge", a.requirePermission(identity.PermissionManageOperations, http.HandlerFunc(a.customTabKeyChallenge)))
	mux.Handle("POST /defined/tabs/{id}/key-delivery", a.requirePermission(identity.PermissionManageOperations, http.HandlerFunc(a.customTabKeyDelivery)))
	...
	mux.Handle("GET /config/dashboards/config-format", a.requirePermission(identity.PermissionManageOperations, http.HandlerFunc(a.downloadDashboardConfigFormat)))
	...
	mux.Handle("POST /config/dashboard-cards/{id}/actions/{actionId}/trigger", a.requirePermission(identity.PermissionExecute, http.HandlerFunc(a.triggerCustomDashboardCardAction)))
	mux.Handle("POST /config/dashboard-cards/{id}/flow/run", a.requirePermission(identity.PermissionExecute, http.HandlerFunc(a.runCustomDashboardCardFlow)))
	mux.Handle("GET /config/dashboard-cards/{id}/flow/events", a.requirePermission(identity.PermissionObserve, http.HandlerFunc(a.customDashboardCardFlowEvents)))
	mux.Handle("GET /config/dashboard-cards/{id}/flow/history", a.requirePermission(identity.PermissionObserve, http.HandlerFunc(a.customDashboardCardFlowHistory)))
	mux.Handle("POST /config/dashboards/{id}/visibility", a.requirePermission(identity.PermissionManageOperations, http.HandlerFunc(a.updateCustomDashboardVisibility)))
	mux.Handle("POST /config/dashboards/{id}/access-key/rotate", a.requireStepUp(identity.PermissionManageOperations, http.HandlerFunc(a.rotateCustomDashboardAccessKey)))
	mux.Handle("POST /config/dashboards/{id}/access-key/revoke", a.requireStepUp(identity.PermissionManageOperations, http.HandlerFunc(a.revokeCustomDashboardAccessKey)))
	...
	mux.Public("POST /public/dashboard/{slug}/cards/{id}/actions/{actionId}/trigger", a.triggerPublicDashboardCardAction)
	mux.Public("POST /public/dashboard/{slug}/cards/{id}/actions/{actionId}/status", a.publicDashboardActionStatus)
	...
	mux.Handle("GET /resources/documents", a.requirePermission(identity.PermissionReadFiles, http.HandlerFunc(a.documentsPage)))
	...
	mux.Handle("POST /resources/files/batch-download", a.requirePermission(identity.PermissionReadFiles, http.HandlerFunc(a.downloadBatchFiles)))
	...
	mux.Handle("POST /resources/files/batch-delete", a.requirePermission(identity.PermissionWriteFiles, http.HandlerFunc(a.trashBatchFiles)))
	mux.Handle("POST /resources/files/move", a.requireStepUp(identity.PermissionWriteFiles, http.HandlerFunc(a.moveFile)))
	mux.Handle("POST /resources/files/batch-move", a.requireStepUp(identity.PermissionWriteFiles, http.HandlerFunc(a.moveBatchFiles)))
	mux.Handle("POST /resources/files/permissions", a.requireStepUp(identity.PermissionWriteFiles, http.HandlerFunc(a.setFilePermissions)))
	...
	mux.Handle("GET /config/groups/{id}/edit", a.requirePermission(identity.PermissionManageOperations, http.HandlerFunc(a.editRecordGroupTask)))
	mux.Handle("GET /config/groups/{id}/delete", a.requirePermission(identity.PermissionManageOperations, http.HandlerFunc(a.deleteRecordGroupTask)))
	mux.Handle("POST /config/groups/{id}/update", a.requirePermission(identity.PermissionManageOperations, http.HandlerFunc(a.updateRecordGroup)))
	mux.Handle("POST /config/groups/{id}/move", a.requirePermission(identity.PermissionManageOperations, http.HandlerFunc(a.moveRecordGroup)))
	mux.Handle("POST /config/groups/{id}/delete", a.requirePermission(identity.PermissionManageOperations, http.HandlerFunc(a.deleteRecordGroup)))
	...
	mux.Handle("GET /config/quick-runs/groups/new", a.requirePermission(identity.PermissionManageExecution, http.HandlerFunc(a.newRecordGroupTask)))
	mux.Handle("POST /config/quick-runs/groups", a.requirePermission(identity.PermissionManageExecution, http.HandlerFunc(a.createRecordGroup)))
	mux.Handle("GET /config/quick-runs/groups/{id}/edit", a.requirePermission(identity.PermissionManageExecution, http.HandlerFunc(a.editRecordGroupTask)))
	mux.Handle("POST /config/quick-runs/groups/{id}/update", a.requirePermission(identity.PermissionManageExecution, http.HandlerFunc(a.updateRecordGroup)))
	mux.Handle("POST /config/quick-runs/groups/{id}/move-top", a.requirePermission(identity.PermissionManageExecution, http.HandlerFunc(a.moveRecordGroup)))
	mux.Handle("POST /config/quick-runs/groups/{id}/delete", a.requirePermission(identity.PermissionManageExecution, http.HandlerFunc(a.deleteRecordGroup)))
	...
	mux.Handle("GET /config/quick-runs/{id}/run", a.requirePermission(identity.PermissionExecute, http.HandlerFunc(a.runQuickRunParamsTask)))
	...
	mux.Handle("GET /config/schedules/groups/new", a.requirePermission(identity.PermissionManageExecution, http.HandlerFunc(a.newRecordGroupTask)))
	mux.Handle("POST /config/schedules/groups", a.requirePermission(identity.PermissionManageExecution, http.HandlerFunc(a.createRecordGroup)))
	mux.Handle("GET /config/schedules/groups/{id}/edit", a.requirePermission(identity.PermissionManageExecution, http.HandlerFunc(a.editRecordGroupTask)))
	mux.Handle("POST /config/schedules/groups/{id}/update", a.requirePermission(identity.PermissionManageExecution, http.HandlerFunc(a.updateRecordGroup)))
	mux.Handle("POST /config/schedules/groups/{id}/move", a.requirePermission(identity.PermissionManageExecution, http.HandlerFunc(a.moveRecordGroup)))
	mux.Handle("POST /config/schedules/groups/{id}/delete", a.requirePermission(identity.PermissionManageExecution, http.HandlerFunc(a.deleteRecordGroup)))
	...
	mux.Handle("POST /config/schedules/{id}/move", a.requirePermission(identity.PermissionManageExecution, http.HandlerFunc(a.moveSchedule)))
	...
	mux.Handle("GET /config/external-interfaces/approvals/{id}/download", a.requirePermission(identity.PermissionManageExecution, http.HandlerFunc(a.downloadExternalApprovalUpload)))
	...
	return http.HandlerFunc(func(response http.ResponseWriter, request *http.Request) {
		...
		origins, err := a.loadEmbeddingOrigins(request.Context())
		if err != nil {
			response.Header().Set("X-Frame-Options", "DENY")
			response.Header().Set("Content-Security-Policy", "frame-ancestors 'none'")
			http.Error(response, "Unable to load embedding settings", http.StatusInternalServerError)
			return
		}
		request = request.WithContext(context.WithValue(request.Context(), embeddingOriginsContextKey{}, origins))
		if len(origins) == 0 {
			response.Header().Set("X-Frame-Options", "DENY")
		}
		request = request.WithContext(context.WithValue(request.Context(), embeddingContextKey{}, len(origins) > 0))
		...
		response.Header().Set("Content-Security-Policy", a.contentSecurityPolicy(request))
