...
func shellNavigation(locale webLocale, path string, role identity.Role) []shellNavigationGroup {
	...
	specs := []struct {
		...
		{key: "nav.resources", items: []itemSpec{{"/resources/files", "nav.files", "folder-code", identity.PermissionReadFiles}, {"/resources/workbench", "nav.workbench", "layout-dashboard", identity.PermissionObserve}, {"/resources/documents", "nav.documents", "book-open", identity.PermissionReadFiles}, {"/resources/variables", "nav.variables", "braces", identity.PermissionManageExecution}, {"/resources/databases", "nav.databases", "database", identity.PermissionManageDatabases}, {"/resources/registries", "nav.registries", "package", identity.PermissionManageOperations}}},
		{key: "nav.configuration", items: []itemSpec{{"/config/quick-access", "nav.quick_access", "pin", identity.PermissionReadFiles}, {"/config/quick-runs", "nav.quick_runs", "zap", identity.PermissionObserve}, {"/workflow", "nav.workflow", "workflow", identity.PermissionObserve}, {"/config/schedules", "nav.schedules", "calendar-clock", identity.PermissionObserve}, {"/config/external-interfaces", "nav.external_interfaces", "plug", identity.PermissionManageExecution}, {"/config/dashboards", "nav.dashboards", "layout-dashboard", identity.PermissionObserve}, {"/config/custom-tabs", "nav.custom_tabs", "panel-top", identity.PermissionManageOperations}}},
