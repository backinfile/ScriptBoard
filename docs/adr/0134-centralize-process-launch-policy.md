...
This boundary does not itself grant a child identity or sandbox. Run Worker, privileged Broker, AI Runtime tokens, platform Job Objects/namespaces, and resource limits build on this process construction seam.
