...
| 身份、权限与审计 | [ADR-0018 路由鉴权](./0018-authenticate-all-protected-web-routes.md)、[ADR-0041 审计事件](./0041-record-admin-and-system-audit-events.md)、[ADR-0044 Argon2id](./0044-use-only-versioned-argon2id-password-hashes.md)、[ADR-0121 固定用户角色](./0121-use-fixed-instance-wide-user-roles.md) |
...
| 本地 Git 版本保护 | [ADR-0091 单一仓库](./0091-version-eligible-managed-files-in-one-local-git-repository.md)、[ADR-0094 Run 检查点](./0094-checkpoint-version-history-around-active-run-batches.md)、[ADR-0095 单文件恢复](./0095-restore-single-files-with-new-commits.md)、[ADR-0098 安全门](./0098-treat-enabled-version-protection-as-a-safety-gate.md)、[ADR-0102 专用分支](./0102-commit-version-protection-to-a-dedicated-branch.md) |
| Web 架构与体验 | [ADR-0060 纯 Go 服务端渲染](./0060-use-a-server-rendered-pure-go-stack.md)、[ADR-0108 双语 Web](./0108-localize-the-web-in-zh-cn-and-en-us.md)、[ADR-0109 按意图分组路由](./0109-group-web-routes-by-operator-intent.md)、[ADR-0110 Chromium 门禁](./0110-use-desktop-chromium-as-the-browser-gate.md)、[ADR-0113 Markdown 渐进增强](./0113-progressively-render-managed-markdown.md) |
